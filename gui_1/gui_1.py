...
logo = PhotoImage(file="gui_1/img/btn-suma.png")
...
button_sumar1=PhotoImage(file="gui_1/img/boton_sumar.png")
...
button_borrar1=PhotoImage(file="gui_1/img/boton_borrar.png")
...
button_salir1=PhotoImage(file="gui_1/img/boton_salir.png")
